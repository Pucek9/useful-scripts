...
MyClass.prototype.basicFunction = function () {
	return ptor11.getText().then(function (a) {
		return ptor12.getText().then(function (b) {
			return ptor13.getText().then(function (c) {
				return ptor14.getText().then(function (d) {
					console.log(d);
				});
			});
		});
...
MyClass.prototype.normalizedFunction = function () {
	return ptor11.getText().then(function (a) {
...
MyClass.prototype.basicFunction2 = function () {
	return ptor31.getText().then(function (a) {
		return ptor32.getText().then(function (b) {
			return ptor33.getText().then(function (c) {
				return ptor34.getText().then(function (d) {
					console.log(d);
				});
			});
		});
...
const MyClass2 = new function () {
	...
	this.normalizedFunction2 = function () {
		return ptor11.getText().then(function (a) {
			return ptor12.getText();
		}).then(function (b) {
			return ptor13.getText();
